 ...
 * @author andre_000
 */
public class CustIdMaximum10000Validator implements CustIdValidationStrategy {
     private final int MAX_CUSTID = 10000;
    
     
     /**
     * This overrides the abstract method from the CustIdValidationStrategy interface.
     * If custID greater then 10000 it throws an exception.
     * @param custId int
     */
    @Override
